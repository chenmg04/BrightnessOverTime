...
%                 'Callback',@obj.frameSelection);
                ...
                hListener = addlistener (hhSlider, hProp, 'PostSet', @obj.frameSelection);
 ...
 t= Tiff (filedir, 'r');
        ...
        function ajustImageSize (obj, ~, ~)
            ...
            obj.resize.processResize=uicontrol('Style','pushbutton','String','OK',...
                                               'Position',[120 10 50 20],'FontSize',9,...
...
%                             for n=nTrail(1):nTrail(2)
                                ...
                                subplot(row,col,j-ROIn(1)+1);h=plot(t,RelativeF(:,trailN,j),'k','LineWidth',0.5);
                                set(h,'color',[0.827 0.827 0.827]);
                                axis([xmin xmax ymin ymax])
                                if ~get(obj.fluoAnalyzer.showAxis,'value')
                                    axis off;
