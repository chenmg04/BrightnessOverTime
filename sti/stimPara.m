    ...
    methods
        ...
        function obj = stimPara (data, num)
            ...
            obj.h.fig = figure('Name','Stimulus Pattern',...
                ...
                'Color','white',...
                'Units','pixels',...
                'Position',[mainFigPosition(1)+532 mainFigPosition(2) 240 250],...
                'Resize','off',...
            ...
            obj.h.posYEdit           =uicontrol('Style','Edit',...
                ...
                'Parent',hpanel(3),...
                'Callback',@obj.posY);
            obj.h.map             =uicontrol('Style','pushbutton',...
                'String','Map',...
                'BackgroundColor','white',...
                'Position',[145 30 60 25],...
                'Parent',hpanel(3),...
                'Callback',@obj.mapStimulus);
...
%             if isfield (obj.data(1),'stiType')
                    ...
                    if isfield(obj.data(1), 'position')
                        ...
                        set(obj.h.posYEdit,'String',obj.data(1).position(2));
                    else
...
%             obj.data(selectIndex).size.height=get(hObject,'string');
        ...
        function mapStimulus(obj,~,~)
            ...
            pos=strsplit(p{1},',');
            xpos=str2double(pos{1});ypos=str2double(pos{2});
            imsize=strsplit(p{2},',');
            ...
            th = 0:pi/50:2*pi;
            xunit = obj.data(i).size * cos(th) + obj.data(i).position(1);
            yunit = obj.data(i).size * sin(th) + (-1*obj.data(i).position(2));
         ...
         function selectStiList (obj, hObject, ~)
             ...
             set(obj.h.stiDurationEdit,'String',obj.data(selectIndex).duration);
              if isfield(obj.data(selectIndex), 'position')
                        ...
                        set(obj.h.posYEdit,'String',obj.data(selectIndex).position(2));
              end
